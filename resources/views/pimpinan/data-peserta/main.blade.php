...
<div class="card">
	<div class="card-body">
		...
		<a href="{{ route('getPDFPeserta', [$angkatanID]) }}" class="btn btn-green" target="_blank"><i class="fa fa-file-pdf-o"></i> Export To PDF</a><br><br>
	...
	<script>
		$(function(){
			$('#tb-test').DataTable({
				processing: true,
				serverSide: true,
				ajax: '{!! route('getDataPeserta', [$angkatanID]) !!}',
				columns: [
					{ data: 'nik', name: 'nik' },
					{ data: 'nama', name: 'nama' },
					{ data: 'ttl', name: 'ttl' },
