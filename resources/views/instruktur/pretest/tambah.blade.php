...
@section('title', 'Tambah Soal Pre-Test')

@section('content')

<div class="card">
	<div class="card-body">
		<p class="category">Tambah Soal Pre-Test</p><hr>
		<div class="row">
			<div class="col-md-12">
...
<div class="card">
	<div class="card-body">
		<p class="category">Soal Pre-Test</p><hr>
		<div class="row">
		...
		<div class="row">
			<div class="col-md-9 text-center">
				<a href="{{ route('getListJawabanPretest', [$kelasID]) }}" target="_blank">LIHAT JAWABAN DARI PESERTA</a>
			</div>
		</div>
	</div>
</div>
